...
namespace Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Service;
...
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Common\Exception\BadMethodCallException;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Common\Version;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Inflection\InflectorInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Inflection\Inflector;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Client as HttpClient;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Exception\MultiTransferException;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Service\Exception\CommandTransferException;
...
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Service\Command\Factory\FactoryInterface as CommandFactoryInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Service\Resource\ResourceIteratorClassFactory;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Service\Resource\ResourceIteratorFactoryInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Service\Description\ServiceDescriptionInterface;
