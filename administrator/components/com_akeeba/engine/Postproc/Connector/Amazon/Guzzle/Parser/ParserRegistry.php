...
namespace Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Parser;
...
class ParserRegistry
{
    ...
    protected $mapping = array(
        'message'      => 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Parser\\Message\\MessageParser',
        'cookie'       => 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Parser\\Cookie\\CookieParser',
        'url'          => 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Parser\\Url\\UrlParser',
        'uri_template' => 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Parser\\UriTemplate\\UriTemplate',
    );
    ...
    public function __construct()
    {
        ...
        if (extension_loaded('uri_template')) {
            $this->mapping['uri_template'] = 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Parser\\UriTemplate\\PeclUriTemplate';
        }
    }
