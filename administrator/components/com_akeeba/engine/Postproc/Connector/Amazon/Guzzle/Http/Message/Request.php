...
namespace Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Message;

use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Common\Version;
...
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Exception\RequestException;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Exception\BadResponseException;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\ClientInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\EntityBody;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\EntityBodyInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Message\Header\HeaderInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Url;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Parser\ParserRegistry;
...
class Request extends AbstractMessage implements RequestInterface
{
    ...
    /**
     * @deprecated use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Plugin\Cache\DefaultCanCacheStrategy
     * @codeCoverageIgnore
     */
    public function canCache()
    {
        Version::warn(__METHOD__ . ' is deprecated. use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Plugin\Cache\DefaultCanCacheStrategy.');
        if (class_exists('Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Plugin\\Cache\\DefaultCanCacheStrategy')) {
            $canCache = new \Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Plugin\Cache\DefaultCanCacheStrategy();
