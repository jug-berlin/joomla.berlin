...
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Common\AbstractHasDispatcher;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Common\Exception\ExceptionCollection;
...
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Parser\UriTemplate\UriTemplateInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Message\RequestInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Message\RequestFactory;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Message\RequestFactoryInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Curl\CurlMultiInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Curl\CurlMultiProxy;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Curl\CurlHandle;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Curl\CurlVersion;
