...
namespace Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Cache;
...
class CacheAdapterFactory implements FromConfigInterface
{
    ...
    public static function factory($config = array())
    {
        ...
        if (!isset($config['cache.adapter']) && !isset($config['cache.provider'])) {
            $config['cache.adapter'] = 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Cache\\NullCacheAdapter';
