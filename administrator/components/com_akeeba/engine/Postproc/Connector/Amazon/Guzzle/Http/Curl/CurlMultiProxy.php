...
class CurlMultiProxy extends AbstractHasDispatcher implements CurlMultiInterface
{
    ...
    public function __construct($maxHandles = 3, $selectTimeout = 1.0)
    {
        ...
        class_exists('Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Http\\Message\\Response');
        class_exists('Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Http\\Exception\\CurlException');
    }
