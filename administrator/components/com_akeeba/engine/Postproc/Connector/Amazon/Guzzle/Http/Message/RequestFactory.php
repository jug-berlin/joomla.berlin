...
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\RedirectPlugin;
...
class RequestFactory implements RequestFactoryInterface
{
    ...
    protected $requestClass = 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Http\\Message\\Request';

    /** @var string Class to instantiate for requests with a body */
    protected $entityEnclosingRequestClass = 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Http\\Message\\EntityEnclosingRequest';
    ...
    protected function visit_exceptions(RequestInterface $request, $value, $flags)
    {
        if ($value === false || $value === 0) {
            ...
            foreach ($dispatcher->getListeners('request.error') as $listener) {
                if (is_array($listener) && $listener[0] == 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Http\\Message\\Request' && $listener[1] = 'onRequestError') {
