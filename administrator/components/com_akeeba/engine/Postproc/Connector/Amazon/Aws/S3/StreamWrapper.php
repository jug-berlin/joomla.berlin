...
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\S3\Exception\NoSuchKeyException;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\S3\Iterator\ListObjectsIterator;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\EntityBody;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\CachingEntityBody;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Http\Mimetypes;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Iterator\FilterIterator;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Stream\PhpStreamRequestFactory;
...
class StreamWrapper
{
    ...
    protected function openReadStream(array $params, array &$errors)
    {
        ...
        $this->body = $factory->fromRequest($request, array(), array('stream_class' => 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Http\\EntityBody'));
