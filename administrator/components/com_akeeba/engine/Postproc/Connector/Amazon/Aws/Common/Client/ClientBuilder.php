...
namespace Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Client;
...
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Credentials\NullCredentials;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Enum\ClientOptions as Options;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Exception\ExceptionListener;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Exception\InvalidArgumentException;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Exception\NamespaceExceptionFactory;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Exception\Parser\DefaultXmlExceptionParser;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Exception\Parser\ExceptionParserInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Iterator\AwsResourceIteratorFactory;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\RulesEndpointProvider;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Signature\EndpointSignatureInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Signature\SignatureInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Signature\SignatureV2;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Signature\SignatureV3Https;
use Akeeba\Engine\Postproc\Connector\Amazon\Aws\Common\Signature\SignatureV4;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Common\Collection;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Plugin\Backoff\BackoffPlugin;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Plugin\Backoff\CurlBackoffStrategy;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Plugin\Backoff\ExponentialBackoffStrategy;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Plugin\Backoff\HttpBackoffStrategy;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Plugin\Backoff\TruncatedBackoffStrategy;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Service\Description\ServiceDescription;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Service\Resource\ResourceIteratorClassFactory;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Log\LogAdapterInterface;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Log\ClosureLogAdapter;
use Akeeba\Engine\Postproc\Connector\Amazon\Guzzle\Plugin\Backoff\BackoffLogger;
            ...
            if ($logger === 'debug') {
                ...
                throw new InvalidArgumentException(
                    Options::BACKOFF_LOGGER . ' must be set to `debug` or an instance of '
                        . 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Guzzle\\Common\\Log\\LogAdapterInterface'
                );
            }
    ...
    protected function getSignature(ServiceDescription $description, Collection $config)
    {
        ...
        if (is_string($signature)) {
            ...
            throw new InvalidArgumentException('The provided signature is not '
                ...
                . 'Akeeba\\Engine\\Postproc\\Connector\\Amazon\\Aws\\Common\\Signature\\SignatureInterface');
        }
