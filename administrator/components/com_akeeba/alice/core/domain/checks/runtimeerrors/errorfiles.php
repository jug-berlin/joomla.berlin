...
class AliceCoreDomainChecksRuntimeerrorsErrorfiles extends AliceCoreDomainChecksAbstract
{
	...
	{
		parent::__construct(80, JText::_('ALICE_ANALYZE_RUNTIME_ERRORS_ERRORFILES'), $logFile);
	}
	...
	public function check()
	{
		...
		{
			$this->setResult(-1);
			throw new Exception(JText::sprintf('ALICE_ANALYZE_RUNTIME_ERRORS_ERRORFILES_FOUND', implode('<br/>', $error_files)));
		}
	...
	{
		return JText::_('ALICE_ANALYZE_RUNTIME_ERRORS_ERRORFILES_SOLUTION');
	}
}
