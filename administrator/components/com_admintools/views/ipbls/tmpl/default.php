...
$sortFields = array(
	'ip'          => JText::_('ATOOLS_LBL_IPBL_IP'),
	'description' => JText::_('ATOOLS_LBL_IPBL_DESCRIPTION'),
);
?>
<?php if (!$pExists): ?>
...
<form name="adminForm" id="adminForm" action="index.php" method="post" class="form">
	...
	<table class="table table-striped">
		...
		<tr>
			...
			<th>
				<?php echo JHTML::_('grid.sort', 'ATOOLS_LBL_IPBL_IP', 'ip', $this->lists->order_Dir, $this->lists->order, 'browse'); ?>
			</th>
			<th>
				<?php echo JHTML::_('grid.sort', 'ATOOLS_LBL_IPBL_DESCRIPTION', 'description', $this->lists->order_Dir, $this->lists->order, 'browse'); ?>
			</th>
		</tr>
		<tr>
			<td></td>
			<td colspan="2" class="form-inline">
				<input type="text" name="ip" id="ip"
					   ...
					   placeholder="<?php echo JText::_('ATOOLS_LBL_IPBL_IP') ?>"
					/>
		...
		<?php else : ?>
			<tr>
				...
				<span class="label label-info">
					<?php echo JText::_('ATOOLS_ERR_IPBL_NOITEMS') ?>
				</span>
				</td>
			</tr>
		<?php endif ?>
