...
<form action="index.php" method="post" name="adminForm" id="adminForm"
	...
	<fieldset>
		...
		<div class="control-group">
			<label class="control-label"
				   for="fileextensions"><?php echo JText::_('ATOOLS_LBL_SCANNER_FILEEXTENSIONS'); ?></label>
		...
		<div class="control-group">
			<label class="control-label"
				   for="exludefolders"><?php echo JText::_('ATOOLS_LBL_SCANNER_EXCLUDEFOLDERS'); ?></label>
		...
		<div class="control-group">
			<label class="control-label"
				   for="exludefiles"><?php echo JText::_('ATOOLS_LBL_SCANNER_EXCLUDEFILES'); ?></label>
	...
	<fieldset>
		...
		<div class="akeeba-ui-optionrow control-group">
			<label class="control-label"
				   for="runtimebias"><?php echo JText::_('ATOOLS_LBL_SCANNER_RUNTIMEBIAS'); ?></label>
