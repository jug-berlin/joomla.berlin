...
<div class="alert alert-info">
	<p>
		...
		<strong>
			<?php echo JText::_('ATOOLS_LBL_HTMAKER_WILLTHISWORK'); ?>
		</strong>
	</p>
	<p>
		<?php if ($this->isSupported == 0): ?>
			<?php echo JText::_('ATOOLS_LBL_HTMAKER_WILLTHISWORK_NO'); ?>
		<?php elseif ($this->isSupported == 1): ?>
			<?php echo JText::_('ATOOLS_LBL_HTMAKER_WILLTHISWORK_YES'); ?>
		<?php else: ?>
			<?php echo JText::_('ATOOLS_LBL_HTMAKER_WILLTHISWORK_MAYBE'); ?>
		<?php endif;?>
	</p>
</div>
