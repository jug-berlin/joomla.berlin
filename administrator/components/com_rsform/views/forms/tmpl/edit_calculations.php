...
<div id="rsform_layout_msg" class="rsform_error">
	<b><?php echo JText::_('RSFP_CALCULATION_INFO'); ?></b>
</div>
<br />
<table class="admintable">
	<tr>
		...
		<td> = </td>
		<td>
			<input type="text" name="rsfp_expression" id="rsfp_expression" size="100" class="rs_inp rs_80" value="" onclick="toggleDropdown(this,0,1);" onkeydown="closeAllDropdowns();" />
		</td>
	...
	<tbody id="rsfp_calculations">
		...
		<tr id="calculationRow<?php echo $row->id; ?>">
			...
			<td> = </td>
			<td colspan="2">
				<input type="text" name="calculations[<?php echo $row->id; ?>][expression]" id="calculations<?php echo $row->id; ?>expression" size="100" class="rs_inp rs_80" onclick="toggleDropdown(this,0,1);" onkeydown="closeAllDropdowns();" value="<?php echo $this->escape($row->expression); ?>" />
