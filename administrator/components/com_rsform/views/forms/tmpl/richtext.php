...
<form method="post" action="index.php?option=com_rsform" name="adminForm">
	<p>
		<button class="rs_button rs_left" type="button" onclick="submitform('richtext.apply');"><?php echo JText::_('JAPPLY'); ?></button>
		<button class="rs_button rs_left" type="button" onclick="submitform('richtext.save');"><?php echo JText::_('JSAVE'); ?></button>
