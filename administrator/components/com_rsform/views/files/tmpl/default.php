...
<div id="rsform_explorer">
	<button type="button" class="rs_button" onclick="rsform_close_window();"><?php echo JText::_('JCANCEL'); ?></button>
	<?php if ($this->canUpload) { ?>
		...
		<tr>
			...
			<td><input class="rs_button" type="button" value="<?php echo JText::_('RSFP_UPLOAD_FILE'); ?>" onclick="submitbutton('upload')" /></td>
		</tr>
		</table>
	<?php } else { ?>
