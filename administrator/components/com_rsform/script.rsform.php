...
.big-warning b {
	...
	<div id="installer-right">
		...
		<ul class="version-history">
			<li><span class="version">Ver</span> 1.49.11</li>
			<li><span class="version-fixed">Fix</span> Calculations were throwing JS errors when using single quotes in separators.</li>
		</ul>
