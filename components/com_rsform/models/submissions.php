...
class RSFormModelSubmissions extends JModelLegacy
{
	...
	public function getReplacements($user_id) {
		...
		$replace = array('{global:sitename}', '{global:siteurl}', '{global:userid}', '{global:username}', '{global:email}', '{global:useremail}', '{global:fullname}', '{/details}', '{/detailspdf}');
		$with 	 = array($sitename, $siteurl, $user->id, $user->username, $user->email, $user->email, $user->name, '</a>', '</a>');
