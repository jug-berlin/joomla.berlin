  ...
  <div id="page">
    ...
    <div id="header">
      ...
      <h1>
          ...
          <img src="<?php echo $jyaml->imagePath; ?>/site_logo.gif" width="950" height="160" alt="<?php echo JApplication::getCfg('sitename') ?>" />
    ...
    <div id="footer" class="floatbox">
      ...
      <div class="syndicate float_right">
         ...
         * @doc    http://dev.joomla.org/component/option,com_jd-wiki/Itemid,/id,templates:jdoc_statements/
        **/
        $jyaml->getPosition('modules', 'footer', 'syndicate', 'raw', ''); 
        ?>
      </div> 
      <?php endif; ?>
      ...
      <a href="http://validator.w3.org/check?uri=referer"><img
        src="http://www.joomla-in-berlin.de/images/stories/valid-xhtml10.png"
        alt="Valid XHTML 1.0 Transitional" height="31" width="88" /></a> <a href="http://jigsaw.w3.org/css-validator/check/referer">
  <img style="border:0;width:88px;height:31px"
       src="http://www.joomla-in-berlin.de/images/stories/vcss.png"
       alt="Valid CSS!" />
 </a>
    </div>
    <!-- end: #footer -->
