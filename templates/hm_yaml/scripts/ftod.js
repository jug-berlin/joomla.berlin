...
for(i=0;i<arguments.length;i++){
  ...
  if (document.getElementById(arguments[i])) { /* Check elements exists - add Reinhard Hiebl */  
    ...
    h.setAttribute('style','font-weight:bold;font-style:italic;border-top:1px dotted #ccc;margin-top:1em;');
    h.appendChild(document.createTextNode("-- Text Filler --"));
    document.getElementById(arguments[i]).appendChild(h);
