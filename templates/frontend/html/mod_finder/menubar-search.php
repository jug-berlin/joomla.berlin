...
{
	$button = '<button class="btn btn-default hasTooltip" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>';
