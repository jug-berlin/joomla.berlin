 ...
 *
 * @version         $Id: default_item.php 467 2008-07-27 16:52:23Z hieblmedia $
...
<p class="pageinfo">
  ...
  <?php if ($this->item->params->get('show_category') && $this->item->catid && isset($this->item->category)) : ?>
  <span>
...
<p class="readmore<?php echo $this->item->params->get('pageclass_sfx'); ?>">
